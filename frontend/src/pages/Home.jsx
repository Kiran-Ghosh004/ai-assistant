...
import { userDataContext } from '../context/uerContext'
...
<div className='w-full h-[400px] gap-5 overflow-y-auto flex flex-col truncate'>
  {userData.history?.map((his)=>(
    <div className='text-gray-200 text-[18px] w-full h-[30px]  '>{his}</div>
      ...
      <button className='min-w-[150px] h-[60px] mt-[30px] text-black font-semibold  bg-white absolute top-[100px] right-5rounded-full cursor-pointer text-[19px] px-5 py-5 hidden lg:block ' onClick={()=>navigate("/customize")}>Customize your Assistant</button>
